package com.wushuangtech.gamelive.giftView;
...
import com.wushuangtech.gamelive.data.gift.Gift;
import com.wushuangtech.gamelive.net.NetManager;
import com.wushuangtech.gamelive.util.FrescoUtil;
...
//                }
            ...
            mMoney.setText(""+gift.getName());
            mExperience.setText(String.valueOf(gift.getPrice())+"元宝");
