...
public abstract class EnterConfApi {
     ...
     *  @param context 程序上下文
     */
    public abstract void setup(String appID, Context context);
     ...
     *
     */
    public abstract void setup(String appID, Context context, boolean enableChat);
     ...
     */
    public abstract void setVideoMixerBitrate(int bitrate);
     ...
     * 获取采集结束后本地文件路径
     */
    public abstract String getLocalChatPath();
