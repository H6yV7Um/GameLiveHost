...
public class ExternalAudioModule implements AudioSender {
    ...
    */
    ...
    {
        if (mCallback != null && mCallback.get() != null) {
            return mCallback.get().startPlay(userid);
        }
        return false;
    }
    ...
    {
        if (mCallback != null && mCallback.get() != null) {
            return mCallback.get().stopPlay(userid);
        }
        return false;
    }
    ...
    private boolean ReceiveAudioData(long userid, int len)
    {
        ...
        */
        ...
        if (mCallback != null && mCallback.get() != null)
        {
            return mCallback.get().receiveAudioData(userid, receivedBuffer, len);
        }
    ...
    {
        if (mCallback != null && mCallback.get() != null) {
            return mCallback.get().isLocalMuted();
        }
