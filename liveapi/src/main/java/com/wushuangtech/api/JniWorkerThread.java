                ...
                if (communicationHelper != null) {
                    ...
                    switch (msg.what) {
                        ...
                        case JNI_CALL_BACK_ON_CHAT_SEND:
                            communicationHelper.OnChatMessageSent((String)objs[0], (int)objs[1]);
                            break;
                        case JNI_CALL_BACK_ON_CHAT_RECV:
                            communicationHelper.OnChatMessageRecived((long)objs[0],(int)objs[1], (String)objs[2], (String)objs[3]);
                            break;
