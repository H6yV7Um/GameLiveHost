...
public abstract class TTTRtcEngine {
     ...
     * SDK的实例对象
     */
    private static TTTRtcEngineImpl mInstance = null;
     ...
     *
     * @param role          直播场景里的用户角色。see {@link Constants#CLIENT_ROLE_BROADCASTER}
     ...
     * @param sData 消息内容
     */
    public abstract void sendChatMessage(long nDstUserID, int type, String sSeqID, String sData);
     ...
     * @return 语音时长
     */
    public abstract int stopRecordAndSendChatAudio(long nDstUserID);
     ...
     * @param path 语音文件路径
     */
    public abstract void speechRecognition(Context context, String path);
    ...
    public abstract byte[] getRemoteBuffer(String devId);

    public abstract int getRemoteWidth(String devId);

    public abstract int getRemoteHeight(String devId);

    public abstract byte[] getLocalBuffer();

    public abstract int getLocalWidth();

    public abstract int getLocalHeight();
