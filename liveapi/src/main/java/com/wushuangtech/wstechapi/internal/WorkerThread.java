...
public class WorkerThread extends Thread {
    ...
    void setTTTRtcEngine(TTTRtcEngine mTTTRtcEngine) {
            ...
            switch (msg.what) {
                ...
                case ACTION_WORKER_DATA_STATUS:
                    if (GlobalConfig.mIsInRoom) {
                        if (GlobalConfig.mIsEnableVideoMode) {
                            ...
                            // 远端视频统计回调
                            RemoteUserVideoWorkStats[] status = (RemoteUserVideoWorkStats[]) TTTVideoModule.getInstance().
                                    receiveVideoModuleEvent(TTTModuleConstants.VIDEO_REMOTE_STUTS);
                ...
                case ACTION_WORKER_VIDEO_STATUS:
                    ...
                    if (GlobalConfig.mIsInRoom) {
                        ...
                        TTTVideoModule.getInstance().
                                receiveVideoModuleEvent(new VideoModuleConfig(TTTModuleConstants.VIDEO_REMOTE_RTC_STUTS
